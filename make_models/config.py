...
SEGMENT_SECONDS = 30               # אורך כל מקטע
WINDOW_STRIDE_SECONDS = 1          # כרגע ללא overlapping
...
# ============================================================
# 🎹 3. FEATURE EXTRACTION — לוגיקה חכמה ודינאמית
# ============================================================

# מספר החלונות בקטע = זמן חלק / זמן חלון
WINDOWS_PER_SEGMENT = SEGMENT_SECONDS // WINDOW_STRIDE_SECONDS

# 3.2 הגדרת פיצ'רים שמופקים מכל חלון
FEATURES_CONFIG = {
    "MFCC": 13,
...
EMBEDDING_POOLING = "flatten"     # אפשר גם "mean" / "max"
...
# ------------------------------------------------------------
# 🔹 בחירת סוג המודל לחלק ה־Embedding
# ------------------------------------------------------------
# אפשרויות:
#   "dense"       → Fully Connected
#   "gru"         → רצף (טוב לזמן)
#   "transformer" → מתקדם
#   "crnn"        → Convolution + GRU (שילוב מעולה לאודיו)
EMBEDDING_MODEL_TYPE = "transformer"

# ------------------------------------------------------------
# 📌 פרמטרים לפי המודל הנבחר
# ------------------------------------------------------------
